/**
 * LMS Hub — Kỹ Năng AI Cho Chuyên Viên Văn Phòng — Lớp daukhi2026
 * 
...
const CLASS_DIR = join(__dirname, '..');          // = daukhi2026/
const CONTENT_DIR = join(CLASS_DIR, 'content');   // = daukhi2026/content/ (synced from course)
...
export default async function handler(req, res) {
  try {
    // Import from synced core (populated by: npm run sync ky-nang-ai-daukhi daukhi2026)
