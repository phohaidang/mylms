/**
 * LMS Hub — SEO - Tối ưu hóa công cụ tìm kiếm — Lớp D01 (PRODUCTION)
 * 
...
const CLASS_DIR = join(__dirname, '..');          // = D01/
const CONTENT_DIR = join(CLASS_DIR, 'content');   // = D01/content/ (synced from course)
...
export default async function handler(req, res) {
  try {
    // Import from synced core (populated by: npm run sync seo D01)
